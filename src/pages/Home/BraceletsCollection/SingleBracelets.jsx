...
const SingleBracelets = () => {
  const bracelets = useLoaderData();
        ...
        .then((data) => {
          if (data.insertedId) {
            Swal.fire({
              position: "top-end",
              icon: "success",
              title: "Bracelet added on the Cart List",
    ...
    <div className="mt-20 p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-white p-4 flex flex-col gap-3">
          ...
          <h6 className="text-xl font-medium -mb-2">Details Bracelet Info:</h6>
          <p className="text-xl">{description}</p>
          <button
            onClick={() => handleAddToCart(bracelets)}
...
export default SingleBracelets;
